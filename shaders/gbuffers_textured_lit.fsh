/*
 * gbuffers_textured_lit — lit particles, beacon beam, armor glint fallback path.
 */
#version 120
...
#define SHADOW_STRENGTH    0.5  // [0.00 0.50 0.75 1.00]
...
void main() {
    ...
    writeLitGbuffer(albedo.rgb, albedo.a, normal, lmcoord, feetPlayerPos,
