/*
 * gbuffers_particles_translucent — translucent particles (Iris 1.8+).
 */
#version 120

#include "/lib/gbuffers_pass.glsl"

#define PAINTERLY_STRENGTH 0.65 // [0.00 0.25 0.50 0.75 1.00]
#define PALETTE_STRENGTH   0.4  // [0.00 0.25 0.50 0.75 1.00]
